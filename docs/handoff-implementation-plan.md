...
**Why:** Nick is building a portfolio of public projects to establish PM credibility. This project demonstrates multi-agent AI system design, financial domain expertise, and product thinking — all in a single demo-able application.

**What prompted it:** A UChicago research paper (May 2024) showed GPT-4 could predict earnings with 60.4% accuracy vs 52.7% for human analysts using chain-of-thought prompting. We're building an enhanced version as a real product concept.

**Intended outcome:** A polished, publicly shared project with full PM artifacts (PRD, design doc, handoff docs) AND working code. The repo itself tells the story of how a PM thinks through a product.
...
This project follows the Nick Tsueda Builds stage-gated workflow. Each stage runs in a separate Claude Code session with handoff docs in between.
...
### Task 0: Scaffold Project with Nick Tsueda Builds Structure
